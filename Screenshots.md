Deployment. 
Create Stack > Under Prerequisite - Prepare Template > click Build from Infrastructure Composer > Create a Template in Infrastructure Composer > click Create in Infrastructure Composer > At the top there are two choices Canvas/Template > choose Template > then choose between and Yaml/Json > choose Yaml.<img width="1366" height="649" alt="1" src="https://github.com/user-attachments/assets/4a600d6f-6555-4648-9f61-b9be9f1f74ec" />
